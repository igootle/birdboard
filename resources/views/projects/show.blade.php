...
<header class="flex items-center mb-4 py-4">
    <div class="flex justify-between items-center w-full">
        ...
        <a href="{{ $project->path(). "/edit" }}" class="bg-blue-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Edit Project
        </a>
    </div>
</header>
    ...
    <div class="lg:flex -mx-3">
        <div class="lg:w-3/4 px-3 mb-6">
            ...
            <form action="{{ $project->path() }}" method="POST">
               ...
               @method('PATCH')
               <textarea
               class="bg-white rounded-lg p-5 shadow w-full mb-3"
               name="notes"
               style="min-height:  200px"
               placeholder="Anything special that yout want to make a note of?">
               {{ $project->notes }}
               </textarea>
